---
title: Configuration
description: Configure the expressive-code-fullscreen plugin.
---
...
:::note
The above configuration customizes the tooltip text, enables both escape key and back button navigation, adds fullscreen buttons only to titled code blocks, uses custom SVG icons, and sets a slower animation duration of 300ms.
:::
