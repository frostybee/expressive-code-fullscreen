...
/**
 * Default style settings for the fullscreen plugin
 */
const fullscreenStyleSettings = new PluginStyleSettings({
	defaultValues: {
		fullscreen: {
    ...
    `,
		...
		hooks: {
			postprocessRenderedBlock: async (context) => {
				...
				const titleFromProps = (context.codeBlock.props as any)?.title;
...
interface FullscreenStyleSettings {
	/** The background color for the font size control toolbar. Default: `"rgba(90, 88, 88, 0.95)"` */
	toolbarBg: string;

	/** The border color for the font size control toolbar. Default: `"rgba(255, 255, 255, 0.1)"` */
	toolbarBorder: string;

	/** The background color for buttons. Default: `"rgba(58, 57, 57, 0.9)"` */
	buttonBg: string;

	/** The background color for buttons on hover. Default: `"rgba(120, 120, 120, 0.5)"` */
	buttonBgHover: string;

	/** The background color for buttons when active. Default: `"rgba(25, 25, 25, 0.9)"` */
	buttonBgActive: string;

	/** The text color for buttons. Default: `({ theme }) => theme.fg || '#ffffff'` */
	buttonText: string;

	/** The border color for buttons. Default: `"rgba(255, 255, 255, 0.2)"` */
	buttonBorder: string;

	/** The focus outline color for buttons. Default: `"rgba(74, 144, 226, 0.6)"` */
	buttonFocus: string;

	/** The background color for the fullscreen container. Default: `"rgba(0, 0, 0, 0.85)"` */
	containerBg: string;

	/** The shadow color for content elements. Default: `"rgba(0, 0, 0, 0.5)"` */
	contentShadow: string;

	/** The background color for hint tooltips. Default: `"rgba(20, 20, 20, 0.95)"` */
	hintBg: string;

	/** The text color for hint tooltips. Default: `({ theme }) => theme.fg || '#ffffff'` */
	hintText: string;

	/** The border color for hint tooltips. Default: `"rgba(255, 255, 255, 0.2)"` */
	hintBorder: string;
}

declare module '@expressive-code/core' {
	export interface StyleSettings {
		/** Style overrides for the fullscreen plugin. */
		fullscreen: FullscreenStyleSettings;
	}
}
